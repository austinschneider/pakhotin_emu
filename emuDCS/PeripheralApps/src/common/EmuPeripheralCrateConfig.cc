            ...
            void EmuPeripheralCrateConfig::TMBStatus(xgi::Input * in, xgi::Output * out ) 
                throw (xgi::exception::Exception) {
                    ...
                    *out << cgicc::fieldset();
                    ...
                    //
                    *out << cgicc::fieldset();
                    *out << cgicc::legend("LCT Info: Frames Sent to MPC").set("style","color:red") << std::endl ;
                    *out << cgicc::pre();
                    thisTMB->RedirectOutput(out);
            ...
            void EmuPeripheralCrateConfig::TMBUtils(xgi::Input * in, xgi::Output * out ) 
                throw (xgi::exception::Exception) {
                    ...
                    *out << cgicc::br() << std::endl;
                    //
                    //**********************************************************
                    // Begin: TMB Trigger Injector
                    //**********************************************************
                    //
                    *out << cgicc::fieldset().set("style","font-size: 11pt; font-family: arial;");
                    *out << std::endl ;
                    *out << cgicc::legend("TMB Trigger Injector").set("style","color:blue") ;
                    //
                    *out << "Tested functions:"<< std::endl;
                    //
                    *out << cgicc::table().set("border","0");
                    //
                    *out << cgicc::tr();
                    ...
                    *out << cgicc::input().set("type","submit").set("value","Inject ALCT").set("style","color:green") ;
                    sprintf(buf,"%d",tmb);
                    *out << cgicc::input().set("type","hidden").set("value",buf).set("name","tmb");
                    *out << cgicc::form() << std::endl ;
                    *out << cgicc::td();
                    ...
                    *out << cgicc::br() << std::endl;
                    //
                    *out << "Non-tested functions:"<< std::endl;
                    //
                    *out << cgicc::br() << std::endl;
                    //
                    *out << cgicc::table().set("border","0");
                    ...
                    *out << cgicc::input().set("type","submit").set("value","Inject CLCT") ;
                    sprintf(buf,"%d",tmb);
                    *out << cgicc::input().set("type","hidden").set("value",buf).set("name","tmb");
                    *out << cgicc::form() << std::endl ;
                    *out << cgicc::td();
...
//                    std::string TMBBPIDisable = toolbox::toString("/%s/TMBBPIDisable",getApplicationDescriptor()->getURN().c_str());
            ...
            //
            void EmuPeripheralCrateConfig::TMBLoadFirmware(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//    }
  ...
  //
            ...
            void EmuPeripheralCrateConfig::TMBBPIReset(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
             ...
             //
             void EmuPeripheralCrateConfig::TMBBPIDisable(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
             ...
             //
             void EmuPeripheralCrateConfig::TMBBPIEnable(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
             ...
             //
             void EmuPeripheralCrateConfig::TMBBPIWrite(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
             ...
             //
             void EmuPeripheralCrateConfig::TMBBPIRead(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
             ...
             //
             void EmuPeripheralCrateConfig::TMBBPIReadN(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
            ...
            //
             void EmuPeripheralCrateConfig::TMBBPIStatus(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
             ...
             //
             void EmuPeripheralCrateConfig::TMBBPIPromTimerStop(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
             ...
             //
             void EmuPeripheralCrateConfig::TMBBPIPromTimerReset(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
             ...
             //
             void EmuPeripheralCrateConfig::TMBBPIPromTimerStart(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
             ...
             //
             void EmuPeripheralCrateConfig::TMBBPIPromClearStatus(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
             ...
             //
             void EmuPeripheralCrateConfig::TMBBPIPromLoadAddress(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
             ...
             //
             void EmuPeripheralCrateConfig::TMBBPIPromBlockUnlock(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
             ...
             //
             void EmuPeripheralCrateConfig::TMBBPIPromBlockErase(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
             ...
             //
             void EmuPeripheralCrateConfig::TMBBPIPromBlockLock(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
             ...
             //
             void EmuPeripheralCrateConfig::TMBBPITimerRead(xgi::Input * in, xgi::Output * out )
                 throw (xgi::exception::Exception) {
                 //
                 cgicc::Cgicc cgi(in);
                 //
