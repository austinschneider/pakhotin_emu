...
#include "emu/pc/TMB_trigInjector_service.h"
#include "emu/pc/TMB_trigInjector_minIni.h"
...
const char* config_file = "/home/cscdev/pakhotin/TMB_trigInjector_config.ini";
