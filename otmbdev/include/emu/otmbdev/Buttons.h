#ifndef __emu_otmbdev_Buttons_h__
#define __emu_otmbdev_Buttons_h__

#include "emu/utils/Cgi.h"
#include "emu/utils/System.h"
#include "emu/pc/VMEController.h"
//#include "/home/cscotmb/XDAQ/11/TriDAS/emu/emuDCS/PeripheralCore/src/common/VMEController.cc"

#include <vector>
#include <sstream>

#include "emu/otmbdev/Action.h"
#include "emu/otmbdev/LogAction.h"
#include "emu/otmbdev/ActionValue.h"
...
namespace emu { namespace otmbdev {
    ...
    class SetAlctTofDelay : public Action, public ActionValue<int> {
    public:
        SetAlctTofDelay(emu::pc::Crate * crate);
        void display(xgi::Output * out);
        void respond(xgi::Input * in, std::ostringstream & out);
    };
	...
	class YPTest : public Action, public ActionValue<int> {
    public:
        YPTest(emu::pc::Crate * crate);
        void display(xgi::Output * out);
        void respond(xgi::Input * in, std::ostringstream & out);
    };
    ...
    class SetAlctTxRx : public Action, public Action2Values<int, int> {
    public:  
      SetAlctTxRx(emu::pc::Crate * crate);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    }; 

    class SetAlctTxRxposneg : public Action, public Action2Values<int, int> {
    public:  
      SetAlctTxRxposneg(emu::pc::Crate * crate);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };  


    class CrateConfigure : public Action {
    public:
        CrateConfigure(emu::pc::Crate * crate);
        void display(xgi::Output * out);
        void respond(xgi::Input * in, std::ostringstream & out);
    };

    class ConfigureAlct : public Action {
    public:
        ConfigureAlct(emu::pc::Crate * crate);
        void display(xgi::Output * out);
        void respond(xgi::Input * in, std::ostringstream & out);
    };
   
    class ReadAlctTofDelay : public Action {
    public:
        ReadAlctTofDelay(emu::pc::Crate * crate);
        void display(xgi::Output * out);
        void respond(xgi::Input * in, std::ostringstream & out);
    };    
  ...
  class BuckShiftTestDebug : public Action, public ActionValue<int> {
    public:
     BuckShiftTestDebug(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };
    ...
    class TMBReadRegisters : public Action,  public ActionValue<std::string> {
    public:
      TMBReadRegisters(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };
    ...
    public:
      TMBSetRegisters(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };
   ...
   class TMBDisableCLCTInput : public Action, public ActionValue<int> {
    ...
    public:
      PipelineDepthScan_Pulses(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };     
    ...
    public:
      PipelineDepthScan_Cosmics(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };     
    ...
    public:
      TmbDavDelayScan(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };     
    ...
    public:
      L1aDelayScan(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };     
    ...
    public:
      ...
      void respond(xgi::Input * in, xgi::Output * out, std::ostringstream & ssout, std::ostringstream & log) {
        std::string file_name = "otmbdev_" + emu::utils::getDateTime(true) + ".log";
 ...
 class ODMB_OTMB_LCT_Testing : public Action, public ActionValue<int> {
    public:
     ODMB_OTMB_LCT_Testing(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };
  ...
  class Investigate_MissingEvents : public Action, public ActionValue<int> {
    public:
     Investigate_MissingEvents(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };
  ...
  class ODMB_L1A_Testing : public Action, public ActionValue<int> {
    public:
     ODMB_L1A_Testing(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };
  ...
  class RoutineTest_StandardCosmics : public Action, public ActionValue<int> {
    public:
      RoutineTest_StandardCosmics(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };
   ...
   public:
     STEP15TestBed(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
     void display(xgi::Output * out);
     void respond(xgi::Input * in, std::ostringstream & out);
   };
   ...
   public:
     STEP16TestBed(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
     void display(xgi::Output * out);
     void respond(xgi::Input * in, std::ostringstream & out);
   };
   ...
   public:
     ODMBCosmicsTest(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);  
     void display(xgi::Output * out);
     void respond(xgi::Input * in, std::ostringstream & out);
   };
   ...
   public:
     ODMBCosmicsTestV2(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);  
     void display(xgi::Output * out);
     void respond(xgi::Input * in, std::ostringstream & out);
   };
  ...
  class ODMBStepTest16 : public Action {
    public:
	ODMBStepTest16(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
	 void display(xgi::Output * out);
	void respond(xgi::Input * in, std::ostringstream & out);
    };
  ...
  class RoutineTest_ShortCosmicsRun : public Action, public ActionValue<int> {
    public:
      RoutineTest_ShortCosmicsRun(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };
  ...
  class RoutineTest_ShortCosmicsRun_DDUPT : public Action, public ActionValue<int> {
    public:
      RoutineTest_ShortCosmicsRun_DDUPT(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };
    ...
    public:
      RoutineTest_PrecisionPulses(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };
    class RoutineTest_PatternPulses_TMBCounters : public Action {
    public:
      RoutineTest_PatternPulses_TMBCounters(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };
    class STEP9bFibers : public Action {
    public:
      STEP9bFibers(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };     
    ...
    public:
      ButtonTests(emu::pc::Crate * crate, emu::otmbdev::Manager* manager);
      void display(xgi::Output * out);
      void respond(xgi::Input * in, std::ostringstream & out);
    };     
...
#endif //__emu_otmbdev_Buttons_h__
