#ifndef __emu_otmbdev_Manager_h__
#define __emu_otmbdev_Manager_h__
...
namespace otmbdev {
    ...
    public:
      ...
      template <typename T> void addActionByTypename(emu::pc::Crate * crate, emu::otmbdev::Manager* manager );
      template <typename T> void addActionByTypename(emu::pc::Crate * crate);
      template <typename T> void addCommonActionByTypename(emu::pc::Crate * crate, emu::otmbdev::Manager* manager );
